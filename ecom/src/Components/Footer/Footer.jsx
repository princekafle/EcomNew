...
const Footer = () => {
  return (
    ...
    <footer class="bg-slate-950 text-white shadow lg:mt-24 md:mt-24 sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 antialiased">
